...
class BoxOfficeViewController: UIViewController {
    ...
    func bind() {
        ...
        let searchButtonTap = searchBar.rx.searchButtonClicked
        let searchText = searchBar.rx.text.orEmpty
        let recentText = PublishSubject<String>()
        
        let input = BoxOfficeViewModel.Input(searchButtonTap: searchButtonTap, searchText: searchText, recentText: recentText)
